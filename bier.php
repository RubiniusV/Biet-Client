...
start:
    ...
    #preg_match('/Bier: (.+)<br>/', $dp_seite, $matches_b);
    #$dp_bier = $matches_b[1];
    #print $dp_bier;
    #print "\n";
    ...
    abfrage:
        ...
        if ($result != 'nix')
        {
            ...
            #print "\n";
            #print "Aktuelle Stunden: ";
            #print "$jetzt_h\n";
            #print "Aktuelle Minuten: ";
            #print "$jetzt_m\n";
            #print "Aktuelle Sekunden: ";
            #print "$jetzt_s\n";
            print "\n\n";
            zeitabfrage:
            ...
            print "Status führt:$fuehrt\n"; 
                ...
                #4. Neues Gebot
                if (($preis < $dp_bier) and ($preis <50000))
                {
                    if ($preis < ($dp_bier / 2))
                    {
                        $npreis = $preis + 10000;
