...
start:
    ...
    print "Durchschnittspreis Klopapier: ";
    ...
    #preg_match('/Klopapier: (.+)<br>/', $dp_seite, $matches_b);
    #$dp_klopapier = $matches_b[1];
    #print $dp_klopapier;
    #print "\n";
    ...
    abfrage:
        ...
        if ($result != 'nix')
        {
            ...
            print "Status führt:$fuehrt\n"; 
                ...
                #4. Neues Gebot
                if (($preis < $dp_klopapier) and ($preis <50000))
                {
                    if ($preis < ($dp_klopapier / 2))
                    {
                        $npreis = $preis + 10000;
                        print "C Gebot waere: ";
                        print $npreis;
